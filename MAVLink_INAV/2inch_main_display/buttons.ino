...
// - SYS_EN  = GPIO35
//
// This tab uses short press of the PWR/function button to switch
// between the two AHI screens.
// ----------------------------------------------------
...
void setupButtons()
{
  // Keep board powered when using battery power.
  // Harmless when powered by USB.
