// ----------------------------------------------------
// Classic round AHI - portrait version
// ----------------------------------------------------
//
...
void drawClassicAhiBoldText(Arduino_Canvas *display, int x, int y, const char *text, uint16_t colour);
...
void drawClassicAhiRollScale(Arduino_Canvas *display, int cx, int cy, int radius, uint16_t whiteColor);
...
void drawClassicAhiScreen(Arduino_Canvas *display, float roll, float pitch)
{
  ...
  drawClassicAhiRollScale(display, cx, cy, rollRadius, whiteColor);
...
void drawClassicAhiMovingBankPointer(
  ...
  display->fillTriangle(tipX, tipY, base1X, base1Y, base2X, base2Y, outlineColor);
  ...
  display->fillTriangle(yTipX, yTipY, yBase1X, yBase1Y, yBase2X, yBase2Y, pointerColor);
}
